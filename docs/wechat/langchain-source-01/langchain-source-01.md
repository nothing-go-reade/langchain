...
这部分只用于维护和复查，不放进公众号公开正文。

- `libs/core/langchain_core/runnables/base.py`: `Runnable`, `RunnableSequence`, `RunnableParallel`
- `libs/core/langchain_core/runnables/config.py`: `RunnableConfig`, `ensure_config`, `patch_config`
- `libs/core/langchain_core/language_models/chat_models.py`: `BaseChatModel.invoke/generate/_generate_with_cache`
- `libs/core/langchain_core/tools/base.py`: `BaseTool`, schema validation, tool call output formatting
- `libs/langchain_v1/langchain/chat_models/base.py`: `init_chat_model`, provider registry, `_ConfigurableModel`
- `libs/langchain_v1/langchain/agents/factory.py`: `create_agent`, graph construction, model/tools conditional edges
- `libs/langchain_v1/langchain/agents/middleware/types.py`: middleware hook contracts
- `libs/partners/openai/langchain_openai/chat_models/base.py`: OpenAI request/result/tool conversion
- `libs/partners/anthropic/langchain_anthropic/chat_models.py`: Anthropic request/result/tool conversion
- `libs/standard-tests/langchain_tests/unit_tests/chat_models.py`: chat model standard contract
