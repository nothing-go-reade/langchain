# LangChain源码解析02：Runnable把一切串起来 发布包
...
第二篇聚焦 `Runnable` 与 LCEL：解释统一执行协议、`RunnableSequence`、`RunnableParallel`、`coerce_to_runnable`、`RunnableLambda` 与 `RunnableGenerator` 的边界，以及 `RunnableConfig` / callback 如何把运行时上下文传下去。

## 文件清单

- HTML 粘贴版：`docs/wechat/langchain-source-02/langchain-source-02-wechat.html`
- WeChat Markdown：`docs/wechat/langchain-source-02/langchain-source-02-wechat.md`
- 源稿 Markdown：`docs/wechat/langchain-source-02/langchain-source-02.md`
- Runnable 协议图：`docs/wechat/langchain-source-02/assets/runnable-protocol-map.png`
- LCEL 组合图：`docs/wechat/langchain-source-02/assets/lcel-composition-flow.png`
